...
static disk_get_extend_part_count(xdisk_t* disk, u32_t start_sector, u32_t* count);
xfat_err_t xdisk_get_part_count(xdisk_t* disk, u32_t* count);

static xfat_err_t disk_get_extend_part(xdisk_t* disk, xdisk_part_t* xdisk_part, u32_t start_sector, int part_no, u32_t* count);
